...
window.formUtils = (function($) {
   ...
   formValidator.prototype.isValidName = function(str) {
    ...
    formValidator.prototype.isValidAlias = function(str) {
        var def = new RegExp(/^([A-Za-z0-9\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff\u2018\u0027\s]*)$/g);
        var result = def.test(str);
        return result;
    };
   ...
   /**
    * @param date: Must be a String, formatted dd/mm/yyyy
    */
   formValidator.prototype.isValidAge = function(date) {
